...
// Remap RC channel input to 0 to 100 (or -25 to 25 if non-altitude/throttle) range - representing % thrust
rc_channel_1 = map(rc_channel_1,rc_channel_lower_limit,rc_channel_upper_limit,0,100);
rc_channel_2 = map(rc_channel_2,rc_channel_lower_limit,rc_channel_upper_limit,-25,25);    
rc_channel_3 = map(rc_channel_3,rc_channel_lower_limit,rc_channel_upper_limit,-25,25);    
rc_channel_4 = map(rc_channel_4,rc_channel_lower_limit,rc_channel_upper_limit,-25,25);    
...
// Commented out until YAW sensor sorted
...
// ***************************
  ...
  // Auto Stablise PID additions/correction 
